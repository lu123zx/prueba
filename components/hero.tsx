...
export function Hero() {
  return (
    ...
    >
      <svg
        aria-hidden="true"
        className="pointer-events-none absolute -right-24 top-24 hidden h-[520px] w-[520px] text-graphite/[0.06] lg:block"
        viewBox="0 0 400 400"
        fill="none"
      >
        <circle cx="200" cy="200" r="199" stroke="currentColor" />
        <circle cx="200" cy="200" r="140" stroke="currentColor" />
        <line x1="200" y1="1" x2="200" y2="399" stroke="currentColor" />
        <line x1="1" y1="200" x2="399" y2="200" stroke="currentColor" />
      </svg>
      ...
      <div className="relative mt-24 border-y border-graphite/10 lg:mt-32">
